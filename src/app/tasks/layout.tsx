...
export default function TasksLayout({ children }: TasksLayoutProps) {
	...
	return (
		<main className='min-h-screen relative overflow-hidden bg-gradient-to-tr from-red-50 via-teal-50 to-sky-100 dark:from-red-900 dark:via-teal-900 dark:to-sky-900'>
